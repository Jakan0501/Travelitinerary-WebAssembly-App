...
{
    /// <inheritdoc />
    public partial class rcreatedDataBase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Itineraries_Hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Itineraries_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItineraryActivities_Activities_ActivityId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, "Kevin Tong", new DateTime(2024, 1, 20, 11, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 25, 11, 0, 0, 0, DateTimeKind.Unspecified), "Room Cleaning", 4f, "Kevin", 56f, new DateTime(2024, 2, 4, 8, 32, 43, 9, DateTimeKind.Local).AddTicks(6764), new DateTime(2024, 2, 4, 2, 32, 43, 9, DateTimeKind.Local).AddTicks(6752), "Cleaning", "Arthur" });

            migrationBuilder.InsertData(
                table: "Flights",
                columns: new[] { "Id", "AirlineName", "Arrival", "Availableseats", "CheckIn", "CreatedBy", "DateCreated", "DateUpdated", "Departure", "Details", "Price", "SeatClass", "UpdatedBy", "WeekDay" },
                values: new object[] { 1, "Blue Airlines", "New York", 50, new DateTime(2024, 1, 17, 12, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Los Angeles", "Direct flight with in-flight entertainment", 500f, "Business Class", null, "Monday" });

            migrationBuilder.InsertData(
                table: "Hotels",
                columns: new[] { "Id", "Address", "CheckIn", "CheckOut", "CreatedBy", "DateCreated", "DateUpdated", "Details", "Name", "Price", "RoomType", "UpdatedBy" },
                values: new object[] { 1, "Paris", new DateTime(2024, 1, 17, 14, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 20, 11, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Luxurious hotel with spa and scenic view", "Grand Hotel", 300f, "Deluxe Suite", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItineraryActivities_ActivityId",
