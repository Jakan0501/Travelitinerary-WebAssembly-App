...
namespace Travelitinerary.Server.Migrations
{
    ...
    [Migration("20240203183243_rcreatedDataBase")]
    partial class rcreatedDataBase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Travelitinerary.Shared.Domain.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Kevin",
                            Price = 56f,
                            TimeEnd = new DateTime(2024, 2, 4, 8, 32, 43, 9, DateTimeKind.Local).AddTicks(6764),
                            TimeStart = new DateTime(2024, 2, 4, 2, 32, 43, 9, DateTimeKind.Local).AddTicks(6752),
                            Type = "Cleaning",
                            UpdatedBy = "Arthur"
                        });
                });
